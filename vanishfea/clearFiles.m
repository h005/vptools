...
for i=1:numel(modelList)
    for j = 1:numel(suffix)
        clearpath1 = ['/home/h005/Documents/vpDataSet/tools/vpData/' modelList{i} '/vpFea/' modelList{i} suffix{j}];
        clearpath2 = ['/home/h005/Documents/vpDataSet/' modelList{i} '/vpFea/' modelList{i} suffix{j}];
