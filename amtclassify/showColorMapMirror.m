...
for i = 1:16
    for j = 1 : mirrorLength
        psImg(mirrorLine + j,i) = psImg(mirrorLine - j,i);
    end
end
...
mirrorLine = 33;
mirrorLength = mirrorTo - mirrorFrom;
for i = 1:16
    for j = 0 : mirrorLength - 1
        psImg(mirrorLine + j,i) = psImg(j + 1,i) + rand();
    end
    for j = -mirrorLength : 0
        psImg(mirrorLine + j,i) = psImg(-j + 1,i) + rand();
    end
end
